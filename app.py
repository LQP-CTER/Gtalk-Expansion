...
curr_total, curr_active, curr_pct = compute_metrics(selected_date, df_filtered)
prev_total, prev_active, prev_pct = compute_metrics(prev_date, df_filtered)
first_total, first_active, first_pct = compute_metrics(first_date, df_filtered)
